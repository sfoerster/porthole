...
class SessionTimerTest {
    ...
    @Test
    fun `countdown emits decreasing values ending at zero`() =
        runTest {
    ...
    @Test
    fun `countdown with zero emits only zero`() =
        runTest {
    ...
    @Test
    fun `countdown clamps to MAX_TIMEOUT_SECONDS`() =
        runTest {
    ...
    @Test
    fun `countdown with one second emits 1 then 0`() =
        runTest {
