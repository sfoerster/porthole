...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            PortholeTheme {
                PortholeApp(activity = this@MainActivity)
            }
        }
    }
...
/**
 * Root composable hosting the navigation graph for Porthole.
 *
 * @param activity The host [MainActivity] for starting the foreground service.
 */
@Composable
private fun PortholeApp(activity: MainActivity) {
